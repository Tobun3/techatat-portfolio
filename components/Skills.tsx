...
const skills = {
  title: "My skills",
  description:
    "I have a Bachelor Degree of Arts and Science in Business English from South East Asia University. I am currently pursuing a Computer Programming and Analysis Diploma at Seneca Polytechnic.",
  skillList: [
    {
      icon: <FaHtml5 />,
      name: "html 5",
